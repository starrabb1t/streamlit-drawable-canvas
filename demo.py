...
#ок, это исправлено. следующий баг теперь. история прокручивается ровно до того момента, когда был изменен режим. после изменения режима история будто бы сбрасывается. это так?